...
- `c:` for the `pod:` namespace (`http://mee.foundation/ontologies/pod#`) — also used for the graph-DataBook terms (`pod:Graph`, `pod:CGraph`, `pod:MemberGraph`, `pod:FormGraph`, `pod:shape`, `pod:claimant`, `pod:subject`) that live in `pod.ttl`
