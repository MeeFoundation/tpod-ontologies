...
created: 2026-07-10
description: >
  Pod DataBook for folder "Immediate Family" (pod:category: cat:ImmediateFamily). It is a
  ...
  organization name, email), per cat:ImmediateFamily's own pod:TemplatePod.
v4:
